      ...
      <main className="isolate">
            <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14">
              ...
              <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8 text-center sm:text-left">
          ...
          <div className="py-12">
            ...
            {activeTab === 'statuts' && (
              <div className="prose prose-lg prose-slate max-w-3xl mx-auto">
                ...
                <div className="bg-gray-50 p-6 rounded-lg mt-8 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-0 sm:justify-between">
                  <div>
                    <h3 className="text-lg font-semibold">Statuts_ADJOBI_2025.pdf</h3>
                    <p className="text-sm text-gray-500">Version adoptée le 12 mars 2025 - 1.2 MB</p>
                  </div>
                  <button className="flex items-center justify-center gap-x-2 rounded-md bg-[#58c469] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#4ab059] w-full sm:w-auto">
            ...
            {activeTab === 'reglement' && (
              <div className="prose prose-lg prose-slate max-w-3xl mx-auto">
                ...
                <div className="bg-gray-50 p-6 rounded-lg mt-8 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-0 sm:justify-between">
                  <div>
                    <h3 className="text-lg font-semibold">Reglement_Interieur_ADJOBI_2025.pdf</h3>
                    <p className="text-sm text-gray-500">Version adoptée le 18 avril 2025 - 875 KB</p>
                  </div>
                  <button className="flex items-center justify-center gap-x-2 rounded-md bg-[#58c469] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#4ab059] w-full sm:w-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
                  ...
                  {[
                    {
                      ...
                      date: "Adopté le 20 mars 2025",
                      size: "1.8 MB",
                      filename: "Rapport_Annuel_ADJOBI_2024.pdf"
                    },
                    {
                      title: "Rapport annuel 2023",
                      date: "Adopté le 15 février 2024",
                      size: "1.5 MB",
                    ...
                    <div key={rapport.title} className="bg-gray-50 p-6 rounded-lg flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-0 sm:justify-between">
                      <div>
